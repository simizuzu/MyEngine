...
void EnemyMove::SetPlayer(Player* player)
{
	player_ = player;
}

void EnemyMove::SetEnemyTranslation(MyMath::Vector3 translation)
{
	translation_ = translation;
}

void EnemyMove::OnCollision()
{
	//弾発射
	Fire();
	//回転しているか
...
MyMath::Vector3 EnemyMove::GetCenterPosition() const
{
	//ワールド座標に変換
